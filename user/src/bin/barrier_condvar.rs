...
use user_lib::{condvar_create, condvar_signal, condvar_wait, exit, get_time, mutex_create, mutex_lock, mutex_unlock, thread_create, waittid};
...
pub fn main() -> i32 {
    ...
    for _ in 0..thread_count {
        ...
        v.push(thread_create(thread_fn as usize, 0) as usize);
